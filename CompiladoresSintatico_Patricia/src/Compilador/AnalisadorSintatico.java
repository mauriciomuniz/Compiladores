                        ...
                        if ((atual() != null) && (atual().getLexema().equals("="))) {
                            ...
                            if (seguinte().getLexema().equals("=")) {
                                ...
                                while (!(atual().getLexema().equals(";")
                                        ...
                                        || atual().getTipo().equals("CDC")
                                        || atual().getTipo().equals("NROINT")
                                        || atual().getTipo().equals("NROREAL")
...
//<MaisConstantes> ::= ',' Identificador '=' <Valores> <MaisConstantes> | ';' <OutrasConstantes>
...
//<Valores> ::= Cadeia | Identificador <Matriz> | NroInt | NroReal | 'true' | 'false'
    private void valores() {
        ...
        } else if ((atual() != null) && (atual().getTipo().equals("CDC")
                || atual().getTipo().equals("NROINT") || atual().getTipo().equals("NROREAL")
...
//<Matriz> ::= '[' <MatrizId> ']' |  '[' <MatrizId> ']' '[' <MatrizId> ']' | <>
    ...
    private void MatrizId() {
        if (atual().getTipo().equals("IDE") || atual().getTipo().equals("NROINT")) {
            posicaoAtual = posicaoAtual + 1;
        } else {
...
//<MaisVariaveis> ::= ',' Identificador <Matriz> <MaisVariaveis> | ';' <OutrasVariaveis>
...
//<Comandos> ::= <Write> <Comandos> | <Read> <Comandos> | <For> <Comandos> | <If> <Comandos> | <Atribuicao> <Comandos> | <>
...
//<Imprimir> ::= Identificador <Matriz> | Cadeia
    ...
    private void imprimirWrite() {
        if ((atual() != null) && (atual().getTipo().equals("CDC"))) {
            posicaoAtual = posicaoAtual + 1;
        } else if ((atual() != null) && (atual().getTipo().equals("IDE"))) {
            posicaoAtual = posicaoAtual + 1;
            if (atual().getLexema().equals("[")) {
...
//<For> ::= for '(' Identificador '=' <ContadorFor> ';' <ExpCondicional> ';' Identificador Incremento')' '{' <Comandos> '}'
    private void For() {
    ...
    // Identificador '=' <ContadorFor> ';' <ExpCondicional> ';' Identificador Incremento
    private void CondicaoFor() {
        if ((atual() != null) && (atual().getTipo().equals("IDE"))) {
            posicaoAtual = posicaoAtual + 1;
            if ((atual() != null) && (atual().getLexema().equals("="))) {
                posicaoAtual = posicaoAtual + 1;
    ...
    private void If() {
        if ((atual() != null) && (atual().getLexema().equals("if"))) {
            ...
            if ((atual() != null) && (atual().getLexema().equals("("))) {
                ...
                addErro(atual(), "'('");
                while (!(atual().getTipo().equals("NROINT")
                        || atual().getTipo().equals("NROREAL")
                        || atual().getLexema().equals("(")
                        || atual().getLexema().equals("!")
                        || atual().getTipo().equals("IDE")
...
//<AtribuicaoValores> ::= Cadeia | 'true' | 'false' | <ExpAritmetica> | Identificador '(' <ParametrosReais> ')'
    ...
    private void AtribuicaoValores() {
        if ((atual() != null) && (atual().getTipo().equals("IDE"))) {
            posicaoAtual = posicaoAtual + 1;
            if (atual().getLexema().equals("(")) {
                posicaoAtual = posicaoAtual + 1;
...
//<ParametrosReais> ::= <Valores> <MaisParametrosReais>
    ...
    private void ParametrosReais() {
        valores();
        MaisParametrosReais();
    }
//<MaisParametrosReais> ::= ',' <Valores> <MaisParametrosReais> | <>

    private void MaisParametrosReais() {
        if ((atual() != null) && (atual().getLexema().equals(","))) {
            posicaoAtual = posicaoAtual + 1;
            valores();
            MaisParametrosReais();
...
//<Fator> ::= '(' <ExpAritmetica> ')' | Identificador <Matriz> <FatorIncremento> | NroInt | NroReal
    ...
    private void Fator() {
        if ((atual() != null) && (atual().getTipo().equals("IDE"))) {
            ...
            FatorIncremento();
        } else if ((atual().getTipo().equals("NROINT") || atual().getTipo().equals("NROREAL"))) {
            posicaoAtual = posicaoAtual + 1;
        } else if ((atual() != null) && (atual().getLexema().equals("("))) {
            posicaoAtual = posicaoAtual + 1;
            ExpAritmetica();
...
/*else {
            addErro(atual(), "Esperado operador logico do ExpLogicaElse");
            OpLogicoNeg();
            if ((atual() != null) && (atual().getLexema().equals("("))) {
                posicaoAtual = posicaoAtual + 1;
                ExpCondicional();
                if ((atual() != null) && (atual().getLexema().equals(")"))) {
                    ...
                    addErro(atual(), "Esperado ')' do ExpLogicaElse");
                    while (!(atual().getLexema().equals(")")
                            || atual().getLexema().equals(";")
                            || atual().getLexema().equals("}")
                            || atual().getLexema().equals(".")
